    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('breed', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='mainapp.breed', verbose_name='Порода')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('advice', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.advicecard', verbose_name='Совет')),
                ('pet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.animalcard', verbose_name='Питомец')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('animal_who', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.animalcard', verbose_name='Кто лайкнул')),
                ('animal_whom', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='animal_to_animal', to='mainapp.animalcard', verbose_name='Кого лайкнули')),
            ],
            options={
                'verbose_name': 'Лайк',
