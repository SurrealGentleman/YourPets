...
class AnimalCard(models.Model):
    ...
    mission = models.ForeignKey(Mission, on_delete=models.CASCADE, verbose_name='Цель', null=True, blank=True)
    # geolocation =
...
class Like(models.Model):
    ...
    animal_whom = models.ForeignKey(AnimalCard, related_name='animal_to_animal', on_delete=models.CASCADE,
